                            ...
                            <Col lg={6}>
                                <div className="blog-box">
                                    <div className="media blog-box-content align-items-center">
                                        <img src={Img2} alt="" className="img-fluid d-block rounded shadow blog-img mr-3" />
                                    ...
                                    <div className="media blog-box-content align-items-center">
                                        <img src={Img3} alt="" className="img-fluid d-block rounded shadow blog-img mr-3" />
                                        <div className="media-body">
                                    ...
                                    <div className="media blog-box-content align-items-center">
                                        <img src={Img4} alt="" className="img-fluid d-block rounded shadow blog-img mr-3" />
                                        <div className="media-body">
